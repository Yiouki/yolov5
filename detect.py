...
def run(
        ...
        merge=True,  # merge boxes in NMS
        vote=True,  # use vote system in NMS if there is an ensemble of models
):
    source = str(source)
    ...
    webcam = source.isnumeric() or (is_url and not is_file) #or source.endswith('.txt') 
...
def parse_opt():
    ...
    parser.add_argument('--feature-vectors', action='store_true', help='extract the backbone of the model')
